...
class TestEnvironment():
    ...
    def setup_storage_files(self):
        ...
        self.document_tif_dir = os.path.join(self.document_dir, 'tif')
        self.document_gif_dir = os.path.join(self.document_dir, 'gif')
        self.document_pdf_dir = os.path.join(self.document_dir, 'pdf')
        self.document_txt_dir = os.path.join(self.document_dir, 'txt')
        self.document_mpg_dir = os.path.join(self.document_dir, 'mpg')
        ...
        self.file_paths.append(os.path.join(self.document_gif_dir, "00000003.gif"))
        ...
        self.file_paths.append(os.path.join(self.document_txt_dir, "00000005.txt"))
        ...
        self.file_paths.append(os.path.join(self.document_pdf_dir, "00000008.pdf"))
        self.append_file_info(8, 'pdf', None, 1, 3)
        self.file_paths.append(os.path.join(self.document_tif_dir, "00000009.tif"))
        self.append_file_info(9, 'tif', 400, 3, 3)
        self.file_paths.append(os.path.join(self.document_tif_dir, "00000010.tif"))
        self.append_file_info(10, 'tif', 400, 2, 3)
        self.file_paths.append(os.path.join(self.document_txt_dir, "00000011.txt"))
        self.append_file_info(11, 'txt', None, 1, 4)
        self.file_paths.append(os.path.join(self.document_txt_dir, "00000012.txt"))
        self.append_file_info(12, 'txt', None, 1, 5)
        self.file_paths.append(os.path.join(self.document_mpg_dir, "00000013.mpg"))
